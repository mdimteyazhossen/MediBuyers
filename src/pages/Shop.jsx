...
const Shop = () => {
    ...
    //         "consumeType": "Adult: Topical- As 0.05 or 0.1% cream/gel: Apply once in the evening.",
    ...
    //         "consumeType": "Adult- PO- The recommended dose range is 0.5 to 1.0 mg/kg/day given in two divided doses with food for 15 to 20 weeks.",
    ...
    //         "consumeType": "Children over 12 years: 50mg every 12 hours, Adults The usual  dosage is 100 mg every 12 hours. The  dosage and duration varies according to the type of infection.For local use in the gums, the dose is 1mg given beneath the gums.",
    ...
    //         "consumeType": "Adult- PO- The recommended  dosage for duodenal ulcer is 1 g four times per day on an empty stomach.",
    ...
    //         "consumeType": "Topical- A thin film of gel should be applied once a day to affected areas after washing the skin.",
    ...
    //         "consumeType": "Topical- Apply a thin layer to the affected area as directed by your physician.",
    ...
    //         "consumeType": "PO- The recommended dose range is 250 to 1.5gm in divided doses.Topical-Apply a thin layer over the affected skin 4 times per day.",
    ...
    //         "consumeType": "PO - The initial dose is based on patient's condition. Maximum recommended dose is 25/2000mg.",
    ...
    //         "consumeType": "Dose is based on patient’s condition. Maximum recommended dose is 25/45mg.",
    ...
    //         "consumeType": "PO- The recommended initial dose is 250mg/day. It may be adjusted based on patient’s condition.",
    ...
    //         "consumeType": "For hypercholesterolemia- The recommended dose is one 3.75-gram packet once daily or one 1.875-gram packet twice daily.For Type 2 Diabetes- The recommended dose is 6 tablets once daily or 3 tablets twice daily.",
    ...
    //         "consumeType": "The recommended initial dose of ertugliflozin tablets is 5 mg to be taken once a day.The dose of ertugliflozin can be increased to 15 mg once daily to achieve adequate glycemic control",
    ...
    //         "consumeType": "Adult- The initial dose is 5 mcg injected under the skin (subcutaneously) twice daily, 60 minutes before breakfast or dinner.",
    ...
    //         "consumeType": "The treatment is started with a low dose of 2.5 mg per day, and increased up to a maximum of 20 mg per day according to the blood glucose levels.",
    ...
    //         "consumeType": "The starting dose for treating anxiety is 0.25-0.5 mg, 3 times daily using immediate release tablets.",
    ...
    //         "consumeType": "Adult: PO- Depression- Initial:50-75 mg/day; up to 150 mg/day if needed.",
    ...
    //         "consumeType": "Feracrylum is available as a 1% sterile solution (1% w/v feracrylum), as 50 and 15 gm gel tubes (1% w/w feracrylum) and tulle ( 3% w/v feracrylum).",
    ...
    //         "consumeType": " The recommended adult dose is 80 mcg to be given subcutaneously (just under the skin) once a day",
    ...
    //         "consumeType": "The usual dosage is one tablet every 6 hours as needed for pain.",
    ...
    //         "consumeType": "The recommended oral adult dose for metamizole is 500 mg 3-4 times up to a maximum dose of 4000 mg/day.",
    ...
    //         "category": "Fracture"
    //     }, {
    //         "image": "https://newassets.apollo247.com/pub/media/catalog/product/s/u/sus0048.jpg",
    ...
    //         "consumeType": "The dose varies according to the condition.The usual recommended oral dose for dehydroepiandrosterone is 50 to 75 mg/day. Higher doses of 50 mg three times a day have been used for adrenal insufficiency.",
    ...
    //         "image": "https://www.netmeds.com/images/product-v1/600x600/108125/prega_news_card_device_1s_36927_0_2.jpg",
    ...
    //         "expirydate": "2025-12-31",
    //         "price": 298,
    //         "sideEffects": "For external use only. Avoid contact with eyes. Discontinue use if irritation occurs.",
    ...
    //         "image": "https://www.jiomart.com/images/product/original/491947406/johnson-s-baby-cottontouch-newborn-massage-oil-100-ml-product-images-o491947406-p590514099-0-202308230923.jpg?im=Resize=(1000,1000)",
    ...
    //         "expirydate": "2024-11-30",
    //         "price": 250,
    //         "sideEffects": "May cause mild gastrointestinal discomfort in some individuals.",
    ...
    //         "drugName": "Amla Juice",
    //         "manufacturer": "Patanjali Ayurved Limited",
    //         "image": "https://www.patanjaliayurved.net/assets/product_images/thumbs/350_360_1690962103AmlaJuice1ltrNew1.png",
    ...
    //         "disclaimer": "Consult your doctor before starting any new supplement regimen.",
    ...
    //         "price": 128,
    //         "sideEffects": "Contains caffeine; may cause sleeplessness if consumed late in the day.",
    ...
    return (
        ...
        //                 <h2 className="card-title">{data.drugName}</h2>
        //                 <p>{data.category}</p>
